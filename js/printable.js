...
function Project(projectData) {
    ...
    for ( i=0 ; i < x; i++){
        ...
        document.getElementById("project"+i).innerHTML=
            ...
            "<h5 class='projectBoxLink'><a class='projectBoxLink' target='_blank' >"+projectData[i].link+"</a></h5>" +
...
function Article(articleData) {
    ...
    for ( i=0 ; i < x; i++){
        ...
        document.getElementById("article"+i).innerHTML=
            ...
            "<h5 class='articlesLink'><a target='_blank'  class='articlesLink'>"+articleData[i].link+"</a></h5>" +
